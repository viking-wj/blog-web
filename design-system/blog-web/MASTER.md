...
| ----------- | --------- | --------------------- |
| Primary     | `#FE9600` | `--color-primary`     |
| On Primary  | `#FFFFFF` | `--color-on-primary`  |
| Secondary   | `#667085` | `--color-secondary`   |
| Accent/CTA  | `#FE9600` | `--color-accent`      |
| Background  | `#F7F8FA` | `--color-background`  |
| Foreground  | `#24292F` | `--color-foreground`  |
| Muted       | `#EAECF0` | `--color-muted`       |
| Border      | `#E4E7EC` | `--color-border`      |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring        | `#FE9600` | `--color-ring`        |

**Color Notes:** Content-first neutral palette with the project's warm orange brand accent.

### Typography

- **Heading Font:** System UI
- **Body Font:** System UI
- **Mood:** warm, content-first, fast, readable
- **Loading strategy:** use the operating-system font stack; do not load a blocking remote font.
